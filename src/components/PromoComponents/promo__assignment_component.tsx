...
const PromoComponent = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const result = await axiosPrivate.get("/v1/promo/assignments", {
        params: params,
      });
  ...
  const removePromo = async (id: string) => {
    try {
      await axiosPrivate.delete(`/v1/promo/remove_assignments/${id}`);
    fetchData();
      toast.success("Promo user assignment deleted successfully");
    } catch (error: any) {
