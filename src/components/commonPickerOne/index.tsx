...
const CommonPicker = ({value, heading,onChange}:{value:any, heading:any,onChange:any}) => {
  useEffect(() => {
    // Init flatpickr
    flatpickr(".form-datepickerone", {
      mode: "single",
      static: true,
    ...
    <div>
     ...
     {heading}
      ...
      <div className="relative">
        <input
       value={value??""}
          className="form-datepickerone w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
